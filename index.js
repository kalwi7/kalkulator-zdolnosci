...
const livingCostInput = document.getElementById("livingCost-input");
const peopleCountInput = document.getElementById("peopleCount-input");
const estateValueInput = document.getElementById("estateValue-input");
const loanPeriodInput = document.getElementById("loanPeriod-input");
const cardLimitsInput = document.getElementById("cardLimits-input");
const renewableCreditsInput = document.getElementById("renewableCredits-input");
const currentLoansInput = document.getElementById("currentLoans-input");
const parabanksInput = document.getElementById("parabanks-input");
